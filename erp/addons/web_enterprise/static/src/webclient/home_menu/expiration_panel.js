...
export class ExpirationPanel extends Component {
    ...
    async _onBuy() {
        ...
        browser.location = `https://www.jtstorm.com/odoo-enterprise/upgrade?num_users=${nbUsers}`;
    }
    ...
    async _onRenew() {
        ...
        if (expirationDateStr !== oldDate && expirationDate > new DateTime.local()) {
            ...
            this.env.services.navigate("https://www.jtstorm.com/odoo-enterprise/renew", params);
        }
    }
    ...
    async _onUpsell() {
        ...
        const url = "https://www.jtstorm.com/odoo-enterprise/upsell";
