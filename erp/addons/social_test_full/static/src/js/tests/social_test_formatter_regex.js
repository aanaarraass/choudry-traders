...
QUnit.module('Social Formatter Regex', {}, () => {
    QUnit.test('Facebook Message', (assert) => {
        ...
        const testMessage = 'Hello @[542132] Odoo-Social, check this out: https://www.jtstorm.com #crazydeals #odoo';
        ...
        assert.equal(finalMessage, [
            ...
            "check this out:",
            "<a href='https://www.jtstorm.com' target='_blank' rel='noreferrer noopener'>https://www.jtstorm.com</a>",
    ...
    QUnit.test('Instagram Message', (assert) => {
        ...
        const testMessage = 'Hello @Odoo.Social, check this out: https://www.jtstorm.com #crazydeals #odoo';
        const finalMessage = SocialPostFormatterMixin._formatPost(testMessage);
    ...
    QUnit.test('LinkedIn Message', (assert) => {
        ...
        const testMessage = 'Hello, check this out: https://www.jtstorm.com #crazydeals #odoo';
        const finalMessage = SocialPostFormatterMixin._formatPost(testMessage);
